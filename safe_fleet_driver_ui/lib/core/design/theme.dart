...
/// (xem [SfPalette.dark]). Các màn Chế độ lái / Camera cabin / Bản đồ bọc
/// bằng [SfTheme.darkWrap] để luôn tối, kể cả khi phần còn lại của app đang
/// ở chế độ sáng.
class SfTheme {
  const SfTheme._();
  ...
  static ThemeData _build(SfPalette p, Brightness brightness) {
    final scheme =
        ColorScheme.fromSeed(
          seedColor: SfColors.teal,
          brightness: brightness,
          surface: p.surface,
        ).copyWith(
          primary: p.isDark ? p.accent : SfColors.navy,
          onPrimary: p.isDark ? SfColors.darkBg : SfColors.onAccent,
          secondary: p.accent,
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: SfType.body.copyWith(color: p.textMuted),
      ...
      textButtonTheme: TextButtonThemeData(
        style: TextButton.styleFrom(
          ...
          textStyle: SfType.body.copyWith(fontWeight: FontWeight.w600),
        ),
      ),
      ...
      dialogTheme: DialogThemeData(
        ...
        titleTextStyle: SfType.titleCard.copyWith(color: p.textPrimary),
        contentTextStyle: SfType.body.copyWith(color: p.textSecondary),
      ),
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        contentTextStyle: SfType.body.copyWith(color: SfColors.onAccent),
        shape: const RoundedRectangleBorder(
          borderRadius: SfRadius.controlR,
        ),
      ),
