...
export const mockFloodPoints: FloodPoint[] = [
  { id: 'F001', hazardType: 'flood', location: 'Nguyễn Trãi - Hà Đông', lat: 20.9800, lng: 105.7870, severity: 'heavy', verified: true, reportCount: 5, confidence: 92, lastUpdated: minutesAgo(8), affectedVehicles: 3, affectedRoutes: ['SF-2026-0001', 'SF-2026-0003'], source: '5 tài xế báo cáo', status: 'verified', receivedAt: minutesAgo(8) },
  { id: 'F002', hazardType: 'flood', location: 'Phạm Văn Đồng - Cầu Giấy', lat: 21.0400, lng: 105.7850, severity: 'moderate', verified: true, reportCount: 3, confidence: 78, lastUpdated: minutesAgo(15), affectedVehicles: 2, affectedRoutes: ['SF-2026-0002'], source: '3 tài xế báo cáo', status: 'verified', receivedAt: minutesAgo(15) },
  { id: 'F003', hazardType: 'flood', location: 'Hồ Tùng Mậu - Cầu Diễn', lat: 21.0380, lng: 105.7600, severity: 'light', verified: true, reportCount: 2, confidence: 65, lastUpdated: minutesAgo(25), affectedVehicles: 1, affectedRoutes: ['SF-2026-0003'], source: '2 tài xế báo cáo', status: 'verified', receivedAt: minutesAgo(25) },
  { id: 'F004', hazardType: 'flood', location: 'Đại lộ Thăng Long - Km 8', lat: 21.0250, lng: 105.7300, severity: 'heavy', verified: false, reportCount: 4, confidence: 87, lastUpdated: minutesAgo(10), affectedVehicles: 2, affectedRoutes: ['SF-2026-0004', 'SF-2026-0009'], source: '4 tài xế + cảm biến IoT', status: 'unverified', receivedAt: minutesAgo(10) },
  { id: 'F005', hazardType: 'flood', location: 'Kiều Mai - Phú Diễn', lat: 21.0550, lng: 105.7500, severity: 'moderate', verified: true, reportCount: 3, confidence: 75, lastUpdated: minutesAgo(20), affectedVehicles: 1, affectedRoutes: ['SF-2026-0009'], source: '3 tài xế báo cáo', status: 'verified', receivedAt: minutesAgo(20) },
  { id: 'F006', hazardType: 'flood', location: 'Ngã tư Khuất Duy Tiến - Nguyễn Trãi', lat: 21.0000, lng: 105.8020, severity: 'impassable', verified: true, reportCount: 8, confidence: 95, lastUpdated: minutesAgo(5), affectedVehicles: 4, affectedRoutes: ['SF-2026-0001', 'SF-2026-0006'], source: '8 tài xế + cảm biến IoT', status: 'verified', receivedAt: minutesAgo(5) },
  { id: 'F007', hazardType: 'flood', location: 'Phú Diễn - gần KCN', lat: 21.0580, lng: 105.7420, severity: 'light', verified: false, reportCount: 1, confidence: 45, lastUpdated: minutesAgo(35), affectedVehicles: 0, affectedRoutes: [], source: '1 tài xế báo cáo', status: 'unverified', receivedAt: minutesAgo(35) },
  { id: 'F008', hazardType: 'flood', location: 'Mỹ Đình - Đường Lê Đức Thọ', lat: 21.0300, lng: 105.7700, severity: 'moderate', verified: true, reportCount: 3, confidence: 72, lastUpdated: minutesAgo(18), affectedVehicles: 1, affectedRoutes: ['SF-2026-0006'], source: '3 tài xế báo cáo', status: 'verified', receivedAt: minutesAgo(18) },
];
