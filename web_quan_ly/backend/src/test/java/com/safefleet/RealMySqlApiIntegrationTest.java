...
@Testcontainers
class RealMySqlApiIntegrationTest {
    ...
    @Test
    @Order(1)
    void realMysqlBootstrapsFlywaySeedAndJwtAuth() {
    ...
    @Test
    @Order(3)
    void realCrudTripTelemetryMaintenanceAndDispatchFlowPersistsToMysql() {
        String adminToken = login("admin", "123456");
    ...
    @Test
    @Order(4)
    void realSafetyIncidentFloodDrivingSettingsNotificationAndReportFlowPersistsToMysql() {
        String adminToken = login("admin", "123456");
        FleetFixture fixture = createAvailableFleet(adminToken);
    ...
    @Test
    @Order(6)
    void realMobileDriverFacadeFlowUsesDriverScopeAndPersistsToMysql() {
        String adminToken = login("admin", "123456");
    ...
    void agentRequiresExplicitConfirmationAndExecutesExactlyOnceForItsOwner() {
        ...
        assertThat(understood.path("classificationSource").asText()).isEqualTo("BACKEND_LOCAL_RULE");
        assertThat(jdbcTemplate.queryForObject(
