...
--
-- Current Database: `safefleet`
--

DROP DATABASE IF EXISTS `safefleet`;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `safefleet` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `driving_sessions` (
  ...
  `over_driving_alert_created` BOOLEAN NOT NULL DEFAULT '0',
  `created_at` datetime(6) NOT NULL,
  `updated_at` datetime(6) DEFAULT NULL,
  `deleted` BOOLEAN NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `navigation_route_candidates` (
  ...
  `safe` BOOLEAN NOT NULL DEFAULT '1',
...
CREATE TABLE `pre_trip_checklists` (
  ...
  `driver_id` bigint NOT NULL,
  `vehicle_id` bigint DEFAULT NULL,
  `exterior_checked` BOOLEAN NOT NULL DEFAULT '0',
  `tires_checked` BOOLEAN NOT NULL DEFAULT '0',
  `brake_checked` BOOLEAN NOT NULL DEFAULT '0',
  `lights_checked` BOOLEAN NOT NULL DEFAULT '0',
  `camera_checked` BOOLEAN NOT NULL DEFAULT '0',
  `gps_checked` BOOLEAN NOT NULL DEFAULT '0',
  `documents_checked` BOOLEAN NOT NULL DEFAULT '0',
...
-- Dump completed on 2026-07-27 10:29:20
